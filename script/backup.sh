...
BLINK='\033[5m'
INV='\033[7m'
BLK='\033[30m' ; RED='\033[31m' ; GRN='\033[32m' ; YLW='\033[33m' ; BLU='\033[34m' ; PUR='\033[35m' ; CYN='${NC}\033[36m' ; WHT='\033[37m'
...
echo '> root check'
if [[ $EUID -ne 0 ]]; then
   echo -e "${RED}${B}ERROR:${NC} ${BLINK}This script must be run as root.${NC}" 
   exit 1
else 
