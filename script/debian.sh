...
sudo grep -qxF '$username ALL=(ALL) NOPASSWD: ALL' /etc/sudoers || sudo echo '$username ALL=(ALL) NOPASSWD: ALL' >> /etc/sudoers
echo '... done.'
echo
...
grep -qxF 'ssh-rsa  $username' /home/$username/.ssh/authorized_keys || echo 'ssh-rsa  $username' >> /home/$username/.ssh/authorized_keys
echo '... done.'
echo
