...
set -e
upp
echo -e "${BLU}sudo apt update -y ${NC}"
sudo apt update -y
echo -e "  ${GRN}[√] done.${NC}\n"
echo -e "${BLU}sudo apt full-upgrade -y ${NC}"
sudo apt full-upgrade -y
echo -e "  ${GRN}[√] done.${NC}\n"
echo -e "${BLU}sudo apt autoremove -y ${NC}"
sudo apt autoremove -y
echo -e "  ${GRN}[√] done.${NC}\n"
echo -e "${BLU}sudo apt clean -y ${NC}"
sudo apt clean -y
echo -e "  ${GRN}[√] done.${NC}\n"
echo -e "${BLU}sudo apt autoclean -y ${NC}"
sudo apt autoclean -y
echo -e "  ${GRN}[√] done.${NC}\n"
# update pihole test
if pihole -v PIHOLE &> /dev/null
then
	echo -e "${BLU}sudo pihole -up ${NC}"
	sudo pihole -up
fi
