...
set -e
upp
echo -e "${BLU}${B}sudo apt update -y ${NC}"
sudo apt update -y
echo -e "  ${GRN}[√] done.${NC}\n"
echo -e "${BLU}${B}sudo apt full-upgrade -y ${NC}"
sudo apt full-upgrade -y
echo -e "  ${GRN}[√] done.${NC}\n"
echo -e "${BLU}${B}sudo apt autoremove -y ${NC}"
sudo apt autoremove -y
echo -e "  ${GRN}[√] done.${NC}\n"
echo -e "${BLU}${B}sudo apt clean -y ${NC}"
sudo apt clean -y
echo -e "  ${GRN}[√] done.${NC}\n"
echo -e "${BLU}${B}sudo apt autoclean -y ${NC}"
sudo apt autoclean -y
echo -e "  ${GRN}[√] done.${NC}\n"
# update pihole test
if pihole -v PIHOLE &> /dev/null
then
	echo -e "${BLU}${B}sudo pihole -up ${NC}"
	sudo pihole -up
fi
