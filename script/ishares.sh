...
echo '----  backup  -----------------------------------------------------------------------------------------'
sudo grep -qxF 'unraid:/mnt/user/esxi/backup/docker   /nas/backup     nfs     auto,defaults,nofail 0 0' /etc/fstab || sudo echo 'unraid:/mnt/user/storage/backup/esxi/docker   /nas/backup     nfs     auto,defaults,nofail 0 0' >> /etc/fstab
echo '====================================================================================================='
